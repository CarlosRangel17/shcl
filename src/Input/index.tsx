...
const Input: FunctionComponent<Props> = forwardRef<HTMLInputElement, Props>(
  function TextField(props, ref) {
    ...
    const {
      ...
      setHasValue,
      forwardedRef,
    } = useForwardRefHasValue<HTMLInputElement>(ref);
    ...
    return (
      <div className={clsx(styles["input-wrapper"], wrapperClass)}>
        ...
        {inputMessage && (
          <p className={clsx(styles.footer, errorClass)}>{inputMessage}</p>
        )}
      </div>
    );
  }
